            ...
            <div class="problems-section">
              ...
              <div class="problem-list">
                ...
                >
                  ...
                  <div class="problem-knowledge" v-if="problem.knowledge">
                    <el-tooltip
                      :content="problem.knowledge"
                      placement="right"
                      :show-after="1000"
                      :hide-after="0"
                      effect="dark"
                      :popper-style="{ maxWidth: '300px', wordWrap: 'break-word' }"
                    >
                      <span class="knowledge-text">{{ problem.knowledge }}</span>
                    </el-tooltip>
                  </div>
...
const saveAiAnalysis = () => {
  if (currentAnalyzingRecord.value && aiAnalysisResult.value) {
    currentAnalyzingRecord.value.aiAnalysis = aiAnalysisResult.value
  }
  closeAiDialog()
}
