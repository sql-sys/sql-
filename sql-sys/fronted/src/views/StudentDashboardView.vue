      ...
      <el-main class="main-content">
        <div class="content-wrapper">
          ...
          <div class="left-section">
            <el-card class="knowledge-card" v-if="formData.selectedProblem">
              <template #header>
              ...
              <div class="knowledge-content">
                <div v-if="dashboardData && dashboardData.knowledge" class="knowledge-item">
                  <div class="knowledge-tags">
                    <el-tag
                      v-for="(tag, index) in getKnowledgeTags(dashboardData.knowledge)"
                      :key="index"
                      type="primary"
                      size="default"
                      class="knowledge-tag"
              ...
              <div class="problem-content">
                ...
                <div v-if="dashboardData" class="data-section">
                  ...
                  <div class="stats-overview">
                    ...
                    <div class="stat-card">
                      <div class="stat-number syntax-error">
                        {{ dashboardData.syntax_error_count }}
                      </div>
                      <div class="stat-title">语法错误数</div>
                    </div>
                    <div class="stat-card">
                      <div class="stat-number result-error">
                        {{ dashboardData.result_error_count }}
                      </div>
...
const updateProblemList = () => {
  const selectedSchemaData = allProblemsData.value.find(
    (item) => item.schema_name === formData.selectedSchema,
  )
...
// 处理知识点标签
const getKnowledgeTags = (knowledge: string) => {
  if (!knowledge) return []
  // 支持多种分隔符：逗号、分号、空格、中文逗号等
  return knowledge.split(/[,;，；\s]+/).filter((tag) => tag.trim().length > 0)
}
